...
#define MSG_AUTO_HOME                       _UxGT("Ir para origem XYZ")
...
#define MSG_LEVEL_BED_DONE                  _UxGT("Fim do nivelamento!")
...
#define MSG_BED_LEVELING                    _UxGT("Nivelamento Mesa")
...
#define MSG_UBL_BUILD_CUSTOM_MESH           _UxGT("Criar Customi")
#define MSG_UBL_BUILD_MESH_MENU             _UxGT("Criar ")
#define MSG_UBL_BUILD_PLA_MESH              _UxGT("Criar PLA")
#define MSG_UBL_BUILD_ABS_MESH              _UxGT("Criar ABS")
#define MSG_UBL_BUILD_COLD_MESH             _UxGT("Criar fria")
...
#define MSG_UBL_MESH_LEVELING               _UxGT("Nivelamento da Malha")
#define MSG_UBL_3POINT_MESH_LEVELING        _UxGT("Nivelamento 3 pontos")
#define MSG_UBL_GRID_MESH_LEVELING          _UxGT("Nivelamento Grid")
...
#define MSG_MOVE_X                          _UxGT("Mover Eixo X")
#define MSG_MOVE_Y                          _UxGT("Mover Eixo Y")
#define MSG_MOVE_Z                          _UxGT("Mover Eixo Z")
...
#define MSG_FAN_SPEED                       _UxGT("Vel. Cooler")
...
#if IS_SCARA
  #define MSG_VA_JERK                       _UxGT("jerk VA")
  #define MSG_VB_JERK                       _UxGT("jerk VB")
  #define MSG_VC_JERK                       _UxGT("jerk VZ")
#elif IS_DELTA
  #define MSG_VA_JERK                       _UxGT("jerk VA")
  #define MSG_VB_JERK                       _UxGT("jerk VB")
  #define MSG_VC_JERK                       _UxGT("jerk VC")
#else
  #define MSG_VA_JERK                       _UxGT("jerk VX")
  #define MSG_VB_JERK                       _UxGT("jerk VY")
  #define MSG_VC_JERK                       _UxGT("jerk VZ")
#endif
#define MSG_VE_JERK                         _UxGT("jerk VE")
...
#define MSG_RESTORE_FAILSAFE                _UxGT("Rest. segura")
#define MSG_INIT_EEPROM                     _UxGT("Iniciar EEPROM")
#define MSG_REFRESH                         LCD_STR_REFRESH _UxGT(" Atualização")
#define MSG_WATCH                           _UxGT("Menu Principal")
#define MSG_PREPARE                         _UxGT("Opções")
...
#define MSG_ZPROBE_OUT                      _UxGT("Sensor fora da mesa")
...
#define MSG_BLTOUCH_DEPLOY                  _UxGT("Abaixar BLTouch")
...
#define MSG_THERMAL_RUNAWAY                 _UxGT("THERMAL_RUNAWAY")
#define MSG_ERR_MAXTEMP                     _UxGT("ERR_MAXTEMP")
...
#define MSG_INFO_PRINT_FILAMENT             _UxGT("Filamento impresso")
...
#define MSG_ERR_PROBING_FAILED              _UxGT("Falha no nivelamento")
  ...
  #define MSG_FILAMENT_CHANGE_INSERT_1      _UxGT("Insira o Filamento")
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1     _UxGT("Extrudando...")
